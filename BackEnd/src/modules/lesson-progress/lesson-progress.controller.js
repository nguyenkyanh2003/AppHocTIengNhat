...
export const postLessonByLessonIdStart = async (req, res) => {
    try {
        const { lessonId } = req.params;
        const userId = req.user._id;
...
export const postLessonByLessonIdUpdate = async (req, res) => {
    try {
        const { lessonId } = req.params;
...
export const postLessonByLessonIdComplete = async (req, res) => {
    try {
        const { lessonId } = req.params;
        const userId = req.user._id;
...
export const postLessonByLessonIdReset = async (req, res) => {
    try {
        const { lessonId } = req.params;
        const userId = req.user._id;
