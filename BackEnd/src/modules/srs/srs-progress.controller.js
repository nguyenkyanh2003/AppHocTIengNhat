...
export const getDueCount = async (req, res) => {
    try {
        const userId = req.user._id;
...
// Trả lời câu hỏi SRS
export const postAnswerById = async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user._id;
...
export const putResetById = async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user._id;
...
export const deleteAdminUserByUserIdClear = async (req, res) => {
    try {
