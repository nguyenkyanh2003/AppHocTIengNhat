...
const Map<String, ({String label, IconData icon})> kSituationLabels = {
  ...
  'shopping': (label: 'Mua sắm', icon: Icons.shopping_bag_outlined),
  'directions': (label: 'Hỏi đường', icon: Icons.signpost_outlined),
  ...
  'workplace': (label: 'Nơi làm việc', icon: Icons.business_center_outlined),
  'neighborhood': (label: 'Khu dân cư', icon: Icons.recycling_outlined),
